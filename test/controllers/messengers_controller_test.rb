...
class MessengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create messenger" do
    assert_difference('Messenger.count') do
      post messengers_url, params: { messenger: { email: @messenger.email, message: @messenger.message, phone: @messenger.phone } }
    end
  ...
  test "should update messenger" do
    patch messenger_url(@messenger), params: { messenger: { email: @messenger.email, message: @messenger.message, phone: @messenger.phone } }
